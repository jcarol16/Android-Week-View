...
public class WeekView extends View {
    ...
    //Gravity Header
    private int mHeaderTextGravity = 17;
    ...
    public WeekView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mTimeColumnTextColor = a.getColor(R.styleable.WeekView_timeColumnTextColor, mTimeColumnTextColor);
            ...
            mHeaderTextGravity = a.getInt(R.styleable.WeekView_headerGravity, Gravity.START);
    ...
    private void init() {
        ...
        mHeaderTextPaint.setTextAlign(Paint.Align.RIGHT);
        ...
        mTodayHeaderTextPaint.setTextAlign(
                (mHeaderTextGravity == Gravity.CENTER) ? Paint.Align.CENTER :
                        (mHeaderTextGravity == Gravity.END) ?

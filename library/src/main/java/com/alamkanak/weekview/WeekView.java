...
public class WeekView extends View {
    ...
    private void init() {
        //Validation Version
        mRegion = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) ? Region.Op.INTERSECT : Region.Op.REPLACE;
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
        ...
        canvas.clipRect(0, mHeaderHeight + mHeaderRowPadding * 2, mHeaderColumnWidth, getHeight(), mRegion);
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        canvas.clipRect(mHeaderColumnWidth, mHeaderHeight + mHeaderRowPadding * 2 + mHeaderMarginBottom + mTimeTextHeight/2, getWidth(), getHeight(), mRegion);
        ...
        canvas.clipRect(0, 0, mTimeTextWidth + mHeaderColumnPadding * 2, mHeaderHeight + mHeaderRowPadding * 2, mRegion);
        canvas.drawRect(0, 0, mTimeTextWidth + mHeaderColumnPadding * 2, mHeaderHeight + mHeaderRowPadding * 2, mHeaderBackgroundPaint);

        // Clip to paint header row only.
        canvas.clipRect(mHeaderColumnWidth, 0, getWidth(), mHeaderHeight + mHeaderRowPadding * 2, mRegion);
